...
int main() {
    //--------------------------------------------------------------------
    //Peers generate Ed25519 keypairs
    //--------------------------------------------------------------------
    unsigned char device_ed25519_secret_key[ crypto_sign_SECRETKEYBYTES ];
    unsigned char device_ed25519_public_key[ crypto_box_PUBLICKEYBYTES ];
    crypto_sign_keypair( device_ed25519_public_key, device_ed25519_secret_key );
    ...
    */
    ...
    crypto_box( box, message, len, nonce, gateway_x25519_public_key, device_x25519_secret_key );
    //--------------------------------------------------------------------
    ...
    */
    ...
    crypto_box_open( unboxed_message, box, len, nonce, device_x25519_public_key, gateway_x25519_secret_key );
    //--------------------------------------------------------------------

    printhex("Device's Ed25519 secret key: ", device_ed25519_secret_key, crypto_sign_SECRETKEYBYTES);
    printhex("Device's Ed25519 public key: ", device_ed25519_public_key, crypto_sign_PUBLICKEYBYTES);
    printhex("Device's X25519 secret key: ", device_x25519_secret_key, crypto_box_SECRETKEYBYTES);
    printhex("Device's X25519 public key: ", device_x25519_public_key, crypto_box_PUBLICKEYBYTES);
